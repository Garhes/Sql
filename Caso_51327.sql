...
cte.CATE_DESCRIPCION AS Descripcion,
pg.PEGE_DOCUMENTOIDENTIDAD,
(pu.PEUN_ANO - TO_NUMBER(TO_CHAR(pu.PEUN_FECHAINICIO, 'YYYY'))) AS Duracion_Prevista,
...
WHERE cte.CATE_DESCRIPCION IN ('EGRESADO', 'NUEVO') 
AND pu.PEUN_ANO >= 2018 
